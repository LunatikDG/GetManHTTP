...
Процедура ПриОткрытии(Отказ)
	...
	ВосстановитьИнтерфейсПриОткрытии();
...
&НаКлиенте
Процедура ВосстановитьИнтерфейсПриОткрытии()
...
Процедура ВыбратьФайлЗавершение(ВыбранныеФайлы, Параметры) Экспорт
	...
	Если ВыбранныеФайлы = Неопределено Тогда
		//@skip-check use-non-recommended-method
		Сообщить("Не выбрано ни одного файла");
	КонецЕсли;
...
Процедура ОтобразитьВариантТелаЗапроса()
	...
	Если ВариантТелаЗапроса = "JSON" Тогда
...
&НаКлиенте
Процедура ОтобразитьАвторизацию()
...
Процедура СформироватьТелоЗапроса(HTTPЗапроса)
	...
	ИначеЕсли ВариантТелаЗапроса = "Binary" Тогда
		...
		Иначе
			//@skip-check use-non-recommended-method
			Сообщить("Предупреждение! Не выбран файл для отправки!");
		КонецЕсли;
	КонецЕсли;
