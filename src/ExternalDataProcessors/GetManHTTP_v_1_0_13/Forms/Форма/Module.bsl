...
Функция ЗаголовкиЗапроса()
	...
	ЗаголовкиЗапросаПользователя = ТаблицаЗначенийВСоответствие();
...
//
// Параметры:
//  ИмяТаблицы - Строка - Реквизит формы таблицы значений который нужно преобразовать в соответствие.
//
// Возвращаемое значение:
//  Соответствие - коллекция строк таблицы в виде структур.
//
&НаСервере
Функция ТаблицаЗначенийВСоответствие(ИмяТаблицы = "Заголовки")
